...
import com.itpvt.v360.Activities.Full_exibition_gallery;
...
/**
 * Created by Itpvt on 04-Dec-17.
 */

public class Recycler_adpater_exibition_gallery extends RecyclerView.Adapter<RecyclerAdapter.MyViewHolder> {//this is the recylerAdapter so you can load upload images in arry as many as you have on the server
    ArrayList<Album> arrayList = new ArrayList<>();
    Activity activity;
    boolean isImageFitToScreen;

    public Recycler_adpater_exibition_gallery(ArrayList<Album> arrayList, Context context) {
...
//                activity.startActivity(intent);
                ...
                Intent intent =new Intent(activity,Full_exibition_gallery.class);
                activity.startActivity(intent);
            }
        });
    }
