...
import com.itpvt.v360.Activities.FullScreenImages;
...
public class RecyclerAdapter extends RecyclerView.Adapter<RecyclerAdapter.MyViewHolder> {//this is the recylerAdapter so you can load upload images in arry as many as you have on the server
...
//                activity.startActivity(intent);
                ...
                Intent intent =new Intent(activity,FullScreenImages.class);
                activity.startActivity(intent);
            }
        });
    }
