...
import com.itpvt.v360.Activities.Full_wedding_gallery;
...
public class Recycler_adapter_wedding_gallery extends RecyclerView.Adapter<RecyclerAdapter.MyViewHolder> {//this is the recylerAdapter so you can load upload images in arry as many as you have on the server
    ArrayList<Album> arrayList = new ArrayList<>();
    Activity activity;
    boolean isImageFitToScreen;

    public Recycler_adapter_wedding_gallery(ArrayList<Album> arrayList, Context context) {
...
//                activity.startActivity(intent);
                ...
                Intent intent =new Intent(activity,Full_wedding_gallery.class);
                activity.startActivity(intent);
            }
        });
    }
