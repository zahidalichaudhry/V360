...
import com.itpvt.v360.Activities.Full_Photog_Screen;
...
public class Recycler_Photog_port extends RecyclerView.Adapter<RecyclerPort.MyViewHolder> {
    String userId;
    ArrayList<AlbumPort> arrayList= new ArrayList<>();
    Activity activity;
    public Recycler_Photog_port(ArrayList<AlbumPort> arrayList, Context context, String url)
    {
        userId=url;
...
//                activity.startActivity(intent);
                Intent intent =new Intent(activity,Full_Photog_Screen.class);
