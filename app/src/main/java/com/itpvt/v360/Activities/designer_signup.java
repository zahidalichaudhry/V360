...
public class designer_signup extends AppCompatActivity {
...
//        this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        setContentView(R.layout.activity_designer_signup);
...
//        }
                ...
                {
                    m_img.requestFocus();
                    Toast.makeText(designer_signup.this.getApplicationContext(),"Please Choose your picture", Toast.LENGTH_SHORT).show();
                }
...
// Create an ArrayAdapter using the string array and a default spinner layout
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(designer_signup.this, R.array.gender_array, android.R.layout.simple_spinner_item);
...
// Apply the adapter to the spinner
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==IMG_REQUEST&&resultCode == RESULT_OK &&data!=null)//chek the conditions for result
        {
            ...
            try {
                bitmap= MediaStore.Images.Media.getBitmap(designer_signup.this.getContentResolver(),path);//from the path store image in bitmap
...
//        String url = Config.URL_VERIFY_MODEL+id;
        String url = "http://itpvt.net/v360app//v360/varify_designer.php?Email="+id+"&Username="+id1;
        loading = ProgressDialog.show(designer_signup.this, "User Creating...", "Please Wait...", false, false);
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        loading.dismiss();
                        Toast.makeText(designer_signup.this, error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });

        RequestQueue requestQueue = Volley.newRequestQueue(designer_signup.this);
            ...
            class UpdateEmployee extends AsyncTask<Void, Void, String> {
                ...
                protected void onPostExecute(String s) {
                    ...
                    if (s.equals("Successfully Register")) {
                        Toast.makeText(designer_signup.this.getApplicationContext(), "Signup Successfully", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(designer_signup.this, Upload_Designer_port.class);
                        intent.putExtra("portusername", portUsername);
                        startActivity(intent);

                    } else {
                        Toast.makeText(designer_signup.this.getApplicationContext(), "Sign in error! Check your network connection", Toast.LENGTH_LONG).show();
                    }
                }
                @Override
                protected String doInBackground(Void... params) {
                    HashMap<String, String> hashMap = new HashMap<>();
                    hashMap.put(Config.SU_DESIGN_NAME, model_nicename);
                    hashMap.put(Config.SU_DESIGN_USERNAME, model_username);
                    hashMap.put(Config.SU_DESIGN_EMAIL, model_email);
                    hashMap.put(Config.SU_DESIGN_PHONE, model_mbl);
                    hashMap.put(Config.SU_DESIGN_AGE, model_age);
                    hashMap.put(Config.SU_DESIGN_GENDER, model_gender);
                    hashMap.put(Config.SU_DESIGN_RECENT, model_recentwork);
                    hashMap.put(Config.SU_DESIGN_ADDRESS, model_address);
                    hashMap.put(Config.SU_DESIGN_PASS, model_pass);
                    hashMap.put(Config.URL,imageUrl);
                    hashMap.put(Config.IMAGE,imageToStrin(bitmap));

                    RequestHandler rh = new RequestHandler();
                    String s = rh.sendPostRequest(Config.URL_CREATE_DESIGNER, hashMap);
                    return s;
                }
            }
