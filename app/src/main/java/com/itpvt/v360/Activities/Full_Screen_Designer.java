...
public class Full_Screen_Designer extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_full__screen__designer);
            viewPager=(ViewPager)findViewById(R.id.view_pager);
            Intent intent=getIntent();
            userID=intent.getStringExtra("portUsername");
            String url= Config.GETTING_DESIGN_PORTFOLIO+userID;
            ...
            JsonArrayRequest jsonArrayRequest= new JsonArrayRequest(Request.Method.POST, url, null,
                    new Response.Listener<JSONArray>() {
                        ...
                        public void onResponse(JSONArray response) {
                            ...
                            adapter=new custom_model_swip(Full_Screen_Designer.this,arrayList);//now we send the name urls to adapter
            ...
            MySingleton2.getmInstance(Full_Screen_Designer.this).addToRequestQue(jsonArrayRequest);
