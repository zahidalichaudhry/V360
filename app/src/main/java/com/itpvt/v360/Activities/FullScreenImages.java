...
public class FullScreenImages extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        JsonArrayRequest jsonArrayRequest= new JsonArrayRequest(Request.Method.POST, Config.serv_url, null,//this is the function through you get the name and url from jsnon arry form php file
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        adapter=new Custom_swip_adapter(FullScreenImages.this,arrayList);//now we send the name urls to adapter
        ...
        MySingleton2.getmInstance(FullScreenImages.this).addToRequestQue(jsonArrayRequest);
