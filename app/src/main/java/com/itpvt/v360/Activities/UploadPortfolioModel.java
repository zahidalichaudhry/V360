...
public class UploadPortfolioModel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_portfolio_model);
                ...
                if(!imagelist.isEmpty()) {
                    for (String imagePath : imagelist)//we chek the image list
                    {
                        try {
                            ...
                            String url = Config.UPLOAD_PROTFOLIO_MODEL;// path of the php file in server
...
//                            Toast.makeText(UploadPortfolioModel.this,"Uploaded Successfully",Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(UploadPortfolioModel.this,"Uploaded Successfully", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(UploadPortfolioModel.this, Home.class);
                    startActivity(intent);
                }
                else
                    {
                        Toast.makeText(UploadPortfolioModel.this,"No image selected", Toast.LENGTH_SHORT).show();
                    }
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new android.support.v7.app.AlertDialog.Builder(UploadPortfolioModel.this)
                .setMessage(message)
