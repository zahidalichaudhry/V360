...
public class Full_Art_Screen extends AppCompatActivity {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full__art__screen);
        viewPager=(ViewPager)findViewById(R.id.view_pager);
        Intent intent=getIntent();
        userID=intent.getStringExtra("portUsername");
        String url= Config.GETTING_ART_PORTFOLIO+userID;
        ...
        JsonArrayRequest jsonArrayRequest= new JsonArrayRequest(Request.Method.POST, url, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        adapter=new custom_model_swip(Full_Art_Screen.this,arrayList);//now we send the name urls to adapter
        ...
        MySingleton2.getmInstance(Full_Art_Screen.this).addToRequestQue(jsonArrayRequest);
    }
}
