...
public class UploadPortfolioPhotog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload_portfolio_photog);
                ...
                if(!imagelist.isEmpty()) {
                    for (String imagePath : imagelist)//we chek the image list
                    {
                        try {
                            ...
                            String url = Config.UPLOAD_PROTFOLIO_PHOTOG;// path of the php file in server
...
//                            Toast.makeText(UploadPortfolioPhotog.this,"Uploaded Successfully",Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(UploadPortfolioPhotog.this,"Uploaded Successfully", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(UploadPortfolioPhotog.this, Home.class);
                    startActivity(intent);
                }
                else
                {
                    Toast.makeText(UploadPortfolioPhotog.this,"No image selected", Toast.LENGTH_SHORT).show();
                }
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new android.support.v7.app.AlertDialog.Builder(UploadPortfolioPhotog.this)
                .setMessage(message)
