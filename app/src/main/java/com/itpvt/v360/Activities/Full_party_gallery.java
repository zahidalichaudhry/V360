...
public class Full_party_gallery extends AppCompatActivity {
    ViewPager viewPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_full_party_gallery);
        ...
        JsonArrayRequest jsonArrayRequest= new JsonArrayRequest(Request.Method.POST, Config.Party_Galler, null,//this is the function through you get the name and url from jsnon arry form php file
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        adapter=new Custom_swip_adapter(Full_party_gallery.this,arrayList);//now we send the name urls to adapter
        ...
        MySingleton2.getmInstance(Full_party_gallery.this).addToRequestQue(jsonArrayRequest);
    }
}
