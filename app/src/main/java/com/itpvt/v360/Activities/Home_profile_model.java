...
public class Home_profile_model extends AppCompatActivity {
...
//        //Remove notification bar
//        this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        setContentView(R.layout.activity_home_profile_model);
...
//                Intent intent = new Intent(Home_profile_model.this,FullScreenImage.class);
...
//        });
        ...
        portfolio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Home_profile_model.this, ViewPortfolio.class);
    ...
    private void getData() {
        ...
        String url = Config.home_model_profile+ID;
