...
public class Upload_Designer_port extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upload__designer_port);
                ...
                if(!imagelist.isEmpty()) {
                    for (String imagePath : imagelist)//we chek the image list
                    {
                        try {
                            ...
                            String url = Config.UPLOAD_PROTFOLIO_DESIGN;// path of the php file in server
...
//                            Toast.makeText(UploadPortfolioModel.this,"Uploaded Successfully",Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(Upload_Designer_port.this,"Uploaded Successfully", Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Upload_Designer_port.this, Home.class);
                    startActivity(intent);
                }
                else
                {
                    Toast.makeText(Upload_Designer_port.this,"No image selected", Toast.LENGTH_SHORT).show();
                }
    ...
    private void showMessageOKCancel(String message, DialogInterface.OnClickListener okListener) {
        new android.support.v7.app.AlertDialog.Builder(Upload_Designer_port.this)
                .setMessage(message)
