...
public class Home_profile_photographers extends AppCompatActivity {
...
//        //Remove notification bar
//        this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        setContentView(R.layout.activity_home_profile_photographers);
...
//        address=(TextView)findViewById(R.id.address);
        m_img = (ImageView)findViewById(R.id.photog_circleView);
...
//                Intent intent = new Intent(Home_profile_photographers.this,FullScreenImage.class);
...
//        });
        ...
        portfolio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Home_profile_photographers.this, ViewPortPhotog.class);
                intent.putExtra("portUsername2",portUsername);
                startActivity(intent);
            }
        });
    ...
    private void getData() {
        ...
        String url = Config.home_photographer_profile+ID;
...
//        address.setText(saddress);
        Glide.with(Home_profile_photographers.this).load(surl).into(m_img);
    }
}
