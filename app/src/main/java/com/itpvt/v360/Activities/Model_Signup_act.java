...
public class Model_Signup_act extends AppCompatActivity {
...
//        this.getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN, WindowManager.LayoutParams.FLAG_FULLSCREEN);
        setContentView(R.layout.activity_model__signup_act);
...
//        }
                ...
                {
                    m_img.requestFocus();
                    Toast.makeText(Model_Signup_act.this.getApplicationContext(),"Please Choose your picture", Toast.LENGTH_SHORT).show();
                }
...
// Create an ArrayAdapter using the string array and a default spinner layout
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(Model_Signup_act.this, R.array.gender_array, android.R.layout.simple_spinner_item);
...
// Apply the adapter to the spinner
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode==IMG_REQUEST&&resultCode == RESULT_OK &&data!=null)//chek the conditions for result
        {
            ...
            try {
                bitmap= MediaStore.Images.Media.getBitmap(Model_Signup_act.this.getContentResolver(),path);//from the path store image in bitmap
...
//        String url = Config.URL_VERIFY_MODEL+id;
        String url = "http://itpvt.net/v360app/v360/verify_model.php?Email="+id+"&Username="+id1;
        loading = ProgressDialog.show(Model_Signup_act.this, "Checking...", "Please Wait...", false, false);
            ...
            public void onResponse(String response) {
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        loading.dismiss();
                        Toast.makeText(Model_Signup_act.this, error.getMessage(), Toast.LENGTH_LONG).show();
                    }
                });

        RequestQueue requestQueue = Volley.newRequestQueue(Model_Signup_act.this);
        ...
        portUsername = model_username;
        {
            ...
            class UpdateEmployee extends AsyncTask<Void, Void, String> {
                ...
                protected void onPreExecute() {
                    super.onPreExecute();
                    loading = ProgressDialog.show(Model_Signup_act.this, "User Creating...", "Please Wait...", false, false);
                }
                @Override
                protected void onPostExecute(String s) {
                    ...
                    if (s.equals("Successfully Register")) {
                        Toast.makeText(Model_Signup_act.this.getApplicationContext(), "Signup Successfully", Toast.LENGTH_LONG).show();
                        Intent intent = new Intent(Model_Signup_act.this, UploadPortfolioModel.class);
                        intent.putExtra("portusername", portUsername);
                        startActivity(intent);

                    } else {
                        Toast.makeText(Model_Signup_act.this.getApplicationContext(), "Sign in error! Check your network connection", Toast.LENGTH_LONG).show();
                    }
                }
                @Override
                protected String doInBackground(Void... params) {
                    ...
                    String s = rh.sendPostRequest(Config.URL_CREATE_MODEL, hashMap);
                    return s;
                }
            }
