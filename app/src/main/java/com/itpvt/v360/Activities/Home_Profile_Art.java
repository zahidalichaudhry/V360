...
public class Home_Profile_Art extends AppCompatActivity {
...
//        address=(TextView)findViewById(R.id.address);
        ...
        portfolio.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(Home_Profile_Art.this, View_Port_Art.class);
    ...
    private void getData() {
        ...
        String url = Config.home_Art_profile+ID;
