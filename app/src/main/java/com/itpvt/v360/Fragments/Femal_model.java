...
import com.itpvt.v360.Adapters.Recycler_Adapter;
 ...
 */
public class Femal_model extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View view = inflater.inflate(R.layout.fragment_femal_model, container, false);
        ...
        JsonArrayRequest jsonArrayRequest= new JsonArrayRequest(Request.Method.POST, Config.female_models_url, null,
                new Response.Listener<JSONArray>() {
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        adapter=new Recycler_Adapter(arrayList,getActivity());
